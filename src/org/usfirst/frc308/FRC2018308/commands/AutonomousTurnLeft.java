...
public class AutonomousTurnLeft extends Command
{
	...
	public AutonomousTurnLeft(double deg)
	{
...
//		System.out.println("current angle " + Chassis.gyro.getAngle());
	...
	protected void execute()
	{
		...
		{
			if(degreesTrav * 100 / degrees < 10 && degreesTrav * 100/degrees > 90) // go faster if greater than 10% of move but less than 90%
			{
					Robot.chassis.turn(-0.4);
					currentHeading();
			}
			else // slow down if in first 10% or last 10% of the move
			{
